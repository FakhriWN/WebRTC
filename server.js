...
function serverHandler(request, response) {
    ...
    try {
        ...
        var matched = false;
        ['/views/', '/public/', '/dist/', '/socket.io/', '/node_modules/canvas-designer/', '/admin/'].forEach(function(item) {
        ...
        try {
            ...
            if (filename.search(/views/g) === -1 && filename.search(/admin/g) === -1 && stats.isDirectory() && config.homePage === '/views/index.html') {
